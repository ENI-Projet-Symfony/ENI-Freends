...
class AppExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new TwigFunction('isMobile', array($this, 'isMobileFunction')),
            new TwigFunction('isDesktop', array($this, 'isDesktopFunction')),
        );
    }

    // chemin relatif de notre fichier en paramètre
    public function isMobileFunction()
    {
        ...
        return $dd->isMobile() ? true : false;
    }

    public function isDesktopFunction()
    {
        // si le fichier passé en paramètre de la fonction existe, on retourne true,
        // sinon on retourne false.
        $userAgent = $_SERVER['HTTP_USER_AGENT'];
        ...
        return $dd->isDesktop() ? true : false;
    }
}